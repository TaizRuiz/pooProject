...
public class AdministracionAuspiciantes {
    ...
    public static void registrar_auspiciante(String id, String nombre, String nombre_responsable, String telefono, String email, String direccion, String sitio_web, TipoServicio servicio,  ArrayList<Socials> redes_sociales, boolean incluye){
